...
<body>
    <div class="container nav_bar">
        ...
        <div class="row">
            <div class="col-8">
                <h2>Всем привет! Я участник 1 этапа PT по специальности кибербезопасность. Зовут меня Влад и мне 18 лет :)</h2>
            </div>
            <div class="col-4">
                <div class="row my_photo"></div>
                <div class="row"><p class="title_photo">Рящиков В.А.</p></div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-12">
                <form class ="form_align" method="POST" action="profile.php" enctype="multipart/form-data" name="upload">
                    ...
                    <textarea name="text" class="form1" cols="30" rows="10" placeholder="Введите текст вашего поста...."></textarea>
